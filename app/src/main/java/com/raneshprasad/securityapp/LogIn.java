            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                        ...
                        }else if(/*postSnapshot.getValue().toString().substring(0, username_str.length()).equals(username_str) || postSnapshot.getValue().toString().substring(username_str.length() + 1).equals(pass_str)*/ !postSnapshot.getValue().toString().equals(username_str + " " +pass_str)) {
